...
urlpatterns = [
    ...
    path("delete/<int:workout_id>/", views.delete_workout, name="delete_workout"), # path to delete workout
    path("add_review/<int:workout_id>/", views.add_review, name="add_review"), # path to add review
]
